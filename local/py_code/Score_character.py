...
if len(sys.argv) != 3 :
	print "Usage: " + sys.argv[0] + " [options] <data-text> <decode-tra> "
	print "e.g.: " + sys.argv[0] + " data/test/text exp/tri3a_mfcc_pitch_dnn_nd4_hd1024/decode_test_lang_test/scoring/log/best_path.15.log"
	print "options: "
	print "			"
else :
	#讀入words與phones的對照表
	...
	character_error_rate = (float(error_count)/float(total_count))*100
	print "character_error_rate:" + str(round(character_error_rate,2)) + "%"
